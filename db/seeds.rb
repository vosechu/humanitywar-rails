...
BlackCard.create!(:text => "________ kid________tested mother________approved.", :blanks => 1)
...
BlackCard.create!(:text => "(Draw 2, Pick 3) ________ + ________ = ________", :blanks => 3)
BlackCard.create!(:text => "(Draw 2, Pick 3) I went from ________ to ________, all thanks to.", :blanks => 3)
BlackCard.create!(:text => "(Draw 2, Pick 3) Make a haiku.", :blanks => 3)
BlackCard.create!(:text => "(Pick 2) ________ would be woefully incomplete without ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) ________ is a slippery slope that leads to ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) An international tribunal has found ________ guilty of ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) An the Academy Award for ________ goes to ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Before ________, all we had was________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Dear Sir or Madam, We regret to inform you that the office of ________ has denied your request for ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) For my next trick, I will pull ________ out of ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) I never truly understood ________ until I encountered ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) I spent my whole life working toward ________, only to have it ruined by ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) If God didn't want us to enjoy ________, he wouldn't have given us ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) In a pinch, ________ can be a suitable substitute for ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) In a world ravaged by ________, our only solace is ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) In M. Night Shamalan's new movie, Bruce Willis discovers that ________ had really been ________ all along.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Lifetime presents ________, the story of ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Michael Bay's new three________hour action epic pits ________ against ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Rumor has it that Vladimir Putin's favorite dish is ________ stuffed with ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) Step 1: ________ Step 2________ Step 3: Profit.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) That's right I killed ________. How you ask? ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) What's the next superhero/sidekick duo?", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) When I was tripping on acid ________ turned into ________.", :blanks => 2)
BlackCard.create!(:text => "(Pick 2) You haven't truly lived until you've experienced ________ and ________ at the same time.", :blanks => 2)
...
BlackCard.create!(:text => "During Picasso's often________overlooked Brown Period, he produced hundreds of paintings of ________.", :blanks => 1)
...
BlackCard.create!(:text => "How am I maintaining my relationship status.", :blanks => 1)
BlackCard.create!(:text => "I do not know with what weapons World War III will be fought, but World War IV will be fought with.", :blanks => 1)
...
BlackCard.create!(:text => "In his new self________produced album, Kanye West raps over the sounds of ________.", :blanks => 1)
...
BlackCard.create!(:text => "MTV's new reality show features eight washed________up celebrities living with ________.", :blanks => 1)
BlackCard.create!(:text => "My country, 'tis of thee, sweet land of ________.", :blanks => 1)
BlackCard.create!(:text => "My mom freaked out when she looked at my browser history and found ________.com/________.", :blanks => 1)
...
BlackCard.create!(:text => "War! What is it good for?", :blanks => 1)
BlackCard.create!(:text => "What am I giving up for Lent?", :blanks => 1)
BlackCard.create!(:text => "What are my parents hiding from me?", :blanks => 1)
BlackCard.create!(:text => "What brought the orgy to a grinding halt?", :blanks => 1)
BlackCard.create!(:text => "What did I bring back from Mexico?", :blanks => 1)
BlackCard.create!(:text => "What did the US airdrop to the children of Afghanistan?", :blanks => 1)
BlackCard.create!(:text => "What did Vin Diesel eat for dinner?", :blanks => 1)
BlackCard.create!(:text => "What do old people smell like?", :blanks => 1)
BlackCard.create!(:text => "What does Dick Cheney prefer?", :blanks => 1)
BlackCard.create!(:text => "What don't you want to find in your Chinese food?", :blanks => 1)
BlackCard.create!(:text => "What ended my last relationship?", :blanks => 1)
BlackCard.create!(:text => "What gets better with age?", :blanks => 1)
BlackCard.create!(:text => "What gives me uncontrollable gas?", :blanks => 1)
BlackCard.create!(:text => "What has been making life difficult at the nudist colony?", :blanks => 1)
BlackCard.create!(:text => "What helps Obama unwind?", :blanks => 1)
BlackCard.create!(:text => "What is Batman's guilty pleasure?", :blanks => 1)
BlackCard.create!(:text => "What keeps me warm during the cold, cold winter?", :blanks => 1)
BlackCard.create!(:text => "What never fails to liven up the party?", :blanks => 1)
BlackCard.create!(:text => "What people like ________.", :blanks => 1)
BlackCard.create!(:text => "What will always get you laid?", :blanks => 1)
BlackCard.create!(:text => "What will I bring back in time to convince people that I am a powerful wizard?", :blanks => 1)
BlackCard.create!(:text => "What would grandma find disturbing, yet oddly charming?", :blanks => 1)
BlackCard.create!(:text => "What's a girl's best friend?", :blanks => 1)
BlackCard.create!(:text => "What's my anti________drug?", :blanks => 1)
BlackCard.create!(:text => "What's my secret power?", :blanks => 1)
BlackCard.create!(:text => "What's Teach for America using to inspire inner city students to succeed?", :blanks => 1)
BlackCard.create!(:text => "What's that smell?", :blanks => 1)
BlackCard.create!(:text => "What's that sound?", :blanks => 1)
BlackCard.create!(:text => "What's the crustiest?", :blanks => 1)
BlackCard.create!(:text => "What's the gift that keeps on giving?", :blanks => 1)
BlackCard.create!(:text => "What's the most emo?", :blanks => 1)
BlackCard.create!(:text => "What's the new fad diet?", :blanks => 1)
BlackCard.create!(:text => "What's the next Happy Meal toy?", :blanks => 1)
BlackCard.create!(:text => "What's there a ton of in heaven?", :blanks => 1)
BlackCard.create!(:text => "When all else fails, I can always masturbate to ________.", :blanks => 1)
BlackCard.create!(:text => "When I am a billionaire, I shall erect a 50________foot statue to commemorate ________.", :blanks => 1)
BlackCard.create!(:text => "When I am President of the United States, I will create the Department of ________.", :blanks => 1)
BlackCard.create!(:text => "When I pooped, what came out of my butt?", :blanks => 1)
...
BlackCard.create!(:text => "Why am I sticky?", :blanks => 1)
BlackCard.create!(:text => "Why can't I sleep at night?", :blanks => 1)
BlackCard.create!(:text => "Why do I hurt all over?", :blanks => 1)
